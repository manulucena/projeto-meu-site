<main>
    <section id="home-section">
        <div class="home-text">
            <h2>Transformando espaços em experiências</h2>
            ...
            <!-- Direcionamento para outras seções -->
            <div class="home-links">
                <a href="?pg=portfolio" class="button">Ver Portfólio</a>
                <a href="?pg=comofunciona" class="button">Saiba como funciona</a>
                <a href="?pg=depoimentos" class="button">Veja os Depoimentos</a>
            </div>
        </div>
    </section>
</main>
